...
namespace MmPhotometer
{
    public partial class Program
    {
        ...
        public void ShowTransmissionChart(IOpticalSpectrum[] spectra, double startWl, double stopWl, double startTr = 0, double stopTr = 100)
        {
            ...
            title.Text = "Filter Transmission";
            title.Font = new Font("Arial", 14, FontStyle.Bold);
            chart.ChartAreas.Add(chartArea);
            chart.Titles.Add(title);
            chart.Size = new Size(_chartWidth, _chartHeight);
            for (int index = 0; index < series.Length; index++)
            {
                series[index] = new Series();
                chart.Series.Add(series[index]);
                series[index].Points.DataBindXY(spectra[index].Wavelengths, spectra[index].Signals);
            ...
            chartArea.Axes[0].Minimum = startWl;
            chartArea.Axes[0].Maximum = stopWl;
            ...
            chartArea.Axes[1].Minimum = startTr;
            chartArea.Axes[1].Maximum = stopTr;
